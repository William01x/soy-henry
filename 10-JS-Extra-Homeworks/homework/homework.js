...
function asAmirror(str) {
  ...
  //Escribe tu código aquí
  let straArray = str.split(" ");
  let ultimoArray = straArray.map(function(elemento){
...
function capicua(numero){
 ...
 let laPosta = numString.split("").reverse().join("");
 if( numString === laPosta){
  return "Es capicua"
 } else {
